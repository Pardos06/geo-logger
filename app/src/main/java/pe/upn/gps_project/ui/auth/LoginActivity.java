...
import pe.upn.gps_project.ui.empleado.MapaEmpleadoActivity;
    ...
    private void ejecutarLogin() {
        ...
        if (usuarioLogueado != null) {
            ...
            if (usuarioLogueado.rol.equals("administrador")) {
                ...
                appDao.insertarAcceso(new Acceso(usuarioLogueado.id, fechaHoraActual));
                ...
                Intent intent = new Intent(this, MapaEmpleadoActivity.class);
                startActivity(intent);
            }
